            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-9">
                    <section class="footer-item">
                        <a href="index-2.html" class="logo carvanr-logo"><img src="assets/images/logoe.png" alt="biolife logo" width="155" height="39"></a>
                        <div class="footer-phone-info">
                            <i class="biolife-icon icon-head-phone"></i>
                            <p class="r-info">
                                <span>Got Questions ?</span>
                                <span>0787-547-140</span>
                            </p>
                        </div>
                    ...
                    <section class="footer-item">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6 col-xs-6">
                                <div class="wrap-custom-menu vertical-menu-2">
                                    <ul class="menu">
                                        ...
                                        <li><a href="../products?name=Products">Products</a></li>
                            ...
                            <div class="col-lg-6 col-sm-6 col-xs-6">
                                <div class="wrap-custom-menu vertical-menu-2">
                                    <ul class="menu">
                                        <li><a href="../store?dis=1">Store</a></li>
                                        <li><a href="../aboutus">About Us</a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <ul class="contact-lines">
                                <li>
                                    <p class="info-item">
                                        ...
                                        <b class="desc">36/5 D5, Ward 25, Bình Thạnh District, HCM City </b>
                                    </p>
                                </li>
                                <li>
                                    <p class="info-item">
                                        <i class="biolife-icon icon-phone"></i>
                                        <b class="desc">Phone: 0787547140</b>
                                    </p>
                                </li>
                                <li>
                                    <p class="info-item">
                                        <i class="biolife-icon icon-letter"></i>
                                        <b class="desc">Email:  electricsolution@gmail.com</b>
                                    </p>
                                </li>
                                <li>
                                    <p class="info-item">
