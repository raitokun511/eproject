...
<div class="container">
    <nav class="biolife-nav">
        <ul>
            <li class="nav-item"><a href="http://127.0.0.1:8000/index" class="permal-link">Home</a></li>
            <li class="nav-item"><a href="#" class="permal-link"><?php echo $brand; ?></a></li>
            <li class="nav-item"><span class="current-page"><?php echo $name; ?></span></li>
        </ul>
    </nav>
</div>
            ...
            <div class="sumary-product single-layout">
                <div class="media">
                    <ul class="biolife-carousel slider-for" data-slick='{"arrows":false,"dots":false,"slidesMargin":30,"slidesToShow":1,"slidesToScroll":1,"fade":true,"asNavFor":".slider-nav"}'>
                        <li><img src=<?php echo $img1; ?> alt="" width="500" height="500"></li>
                        <li><img src=<?php echo $img2; ?> alt="" width="500" height="500"></li>
                        <li><img src=<?php echo $img3; ?> alt="" width="500" height="500"></li>
                    </ul>
                    <ul class="biolife-carousel slider-nav" data-slick='{"arrows":false,"dots":false,"centerMode":false,"focusOnSelect":true,"slidesMargin":10,"slidesToShow":4,"slidesToScroll":1,"asNavFor":".slider-for"}'>
                        <li><img src=<?php echo $img1; ?> alt="" width="88" height="88"></li>
                        <li><img src=<?php echo $img2; ?> alt="" width="88" height="88"></li>
                        <li><img src=<?php echo $img3; ?> alt="" width="88" height="88"></li>                        
                    </ul>
                </div>
                <div class="product-attribute">
                    ...
                    <div class="rating">
                        ...
                        <b class="category">By: car model</b>
                    </div>
                    <!-- <span class="sku">Sku: #76584HH</span> -->
                    <p class="excerpt"><?php echo $info; ?></p>
                    <div class="price">
                        <ins><span class="price-amount"><span class="currencySymbol">$</span><?php echo $prices; ?></span></ins>
                ...
                <div class="tab-content">
                    <div id="tab_1st" class="tab-contain desc-tab active">
                        ...
                        <div class="desc-expand">
                            <span class="title">nice car model</span>
                            <ul class="list">
                                <li>Operate</li>
                                <li>Interior of Suzuki Ciaz 2023</li>
                                <li>Convenient</li>
                            </ul>
                        </div>
                    </div>
