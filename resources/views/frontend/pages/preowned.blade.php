        ...
        <div class="product-tab z-index-20 sm-margin-top-193px xs-margin-top-30px">
            <div class="container">
                <div class="biolife-title-box">
                    <h3 class="main-title">Pre-Owned Car</h3>
                </div>
                            ...
                            <li class="product-item">
                                    <div class="contain-product layout-default">
                                        <div class="product-thumb">
                                            <a href="http://127.0.0.1:8000/detailcar?id=6" class="link-to-product">
                                                <img src="assets/images/home-03/huyndai3.png" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                            </a>
                                            <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                        </div>
                                        <div class="info">
                                            <b class="categories">Huyndai Creta 2022</b>
                                            <div class="price ">
                                                <ins><span class="price-amount"><span class="currencySymbol">$</span>23694.46</span></ins>
                                            ...
                                            <div class="slide-down-box">
                                                ...
                                                <div class="buttons">
                                                    ...
                                                    <a href="http://127.0.0.1:8000/detailcar?id=6" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Read More</a>
                                ...
                                <li class="product-item">
                                    <div class="contain-product layout-default">
                                        <div class="product-thumb">
                                            <a href="http://127.0.0.1:8000/detailcar?id=5" class="link-to-product">
                                                <img src="assets/images/huyndai/huyndai05.jpg" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                            </a>
                                            <a class="lookup btn_call_quickview" href=""><i class="biolife-icon icon-search"></i></a>
                                        </div>
                                        <div class="info">
                                            <b class="categories">Huyndai Santafe</b>
                                            <div class="price ">
                                                <ins><span class="price-amount"><span class="currencySymbol">$</span>22848.08</span></ins>
                                            ...
                                            <div class="slide-down-box">
                                                ...
                                                <div class="buttons">
                                                    <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                    <a href="http://127.0.0.1:8000/detailcar?id=5" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Read More</a>
                                                    <a href="#" class="btn compare-btn"><i class="fa fa-random" aria-hidden="true"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <li class="product-item">
                                    <div class="contain-product layout-default">
                                        <div class="product-thumb">
                                            <a href="http://127.0.0.1:8000/detailcar?id=4" class="link-to-product">
                                                <img src="assets/images/home-03/hinh1.jpg" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                            </a>
                                            <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                        </div>
                                        <div class="info">
                                            <b class="categories">Huyndai Grand i10 Nios</b>
                                            ...
                                            <div class="slide-down-box">
                                                ...
                                                <div class="buttons">
                                                    <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                    <a href="http://127.0.0.1:8000/detailcar?id=4" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Read More</a>
                                                    <a href="#" class="btn compare-btn"><i class="fa fa-random" aria-hidden="true"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <li class="product-item">
                                    <div class="contain-product layout-default">
                                        <div class="product-thumb">
                                            <a href="http://127.0.0.1:8000/detailcar?id=4" class="link-to-product">
                                                <img src="assets/images/home-03/suzuki1.png" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                            </a>
                                            <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                        </div>
                                        <div class="info">
                                            <b class="categories">SWIFT</b>
                                ...
                                <li class="product-item">
                                    <div class="contain-product right-info-layout contain-product__right-info-layout">
                                        ...
                                        <div class="info">
                                            ...
                                            <h4 class="product-title"><a href="http://127.0.0.1:8000/detail" class="pr-name">718 Boxster Style Edition</a></h4>
                                            <div class="price ">
