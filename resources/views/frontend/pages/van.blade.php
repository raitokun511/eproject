                                ...
                                <li class="product-item">
                                    <div class="contain-product layout-default">
                                        <div class="product-thumb">
                                            <a href="http://127.0.0.1:8000/detailcar?id=3" class="link-to-product">
                                                <img src="assets/images/home-03/suzuki2.png" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                            </a>
                                            <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                        </div>
                                        <div class="info">
                                            <b class="categories">Suzuki Ertiga Hybrid Sport Limited 2023</b>
                                            <div class="price ">
                                                <ins><span class="price-amount"><span class="currencySymbol">$</span>73648.08</span></ins>
